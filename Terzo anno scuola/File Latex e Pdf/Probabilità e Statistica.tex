...
\end{document}
% Cerca di mantenere l'indentazione e di spaziare tra i vari ambienti % Grazie bello :3 
% Non sembra, ma aiuta di un sacco la lettura del codice e fidati che ti troverai meglio anche tu
% Ogni tanto se vuoi lascia commenti che li leggo % va bene 3:
